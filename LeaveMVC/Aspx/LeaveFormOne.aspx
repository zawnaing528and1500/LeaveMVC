<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveFormOne.aspx.cs" Inherits="Leave.Aspx.LeaveFormOne" %>
...
<center>
    ...
    <br />
            ...
            <div class="container-fluid">
	            <div class="row">
		            <div class="col-md-6">
                        <input type="tel" name="mobile" id="EmployeePhone" pattern="[0-9]{2}[0-9]{9}" placeholder="Enter Mobile Number" required />
                        ...
                        <textarea cols="30" name="reason" placeholder="Enter Your Leave Reason" required></textarea>
		            </div>
                    <div class="col-md-6">
                       <textarea cols="30" name="reason" placeholder="HOD Comment" required></textarea> 
